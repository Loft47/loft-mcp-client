 ...
 */
export function deriveExpiresAt(raw, opts) {
 ...
 * forever.
 */
export function classifyTokenResult(result) {
...
export class TokenManager {
    ...
    async ensureFresh() {
        ...
        if (token === null)
            throw new AuthExpiredError('No access token');
        if (!this.isStale())
            return token;
    ...
    async performRefresh(knownBad) {
        ...
        if (refreshToken === null)
            return this.giveUp('No refresh token', observedExpiry);
