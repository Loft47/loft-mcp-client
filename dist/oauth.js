...
export class OAuthEndpoints {
    ...
    async register(env, opts) {
        ...
        if (!data.client_id)
            throw new Error('Registration response contained no client_id');
        return {
