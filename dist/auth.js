...
export class AuthFlow {
    ...
    async completeSignIn(code) {
        ...
        const outcome = classifyTokenResult(await this.oauth.postToken(env, {
    ...
    async refresh(refreshToken) {
        const env = this.env();
        const client = await this.storedClient(env);
        return classifyTokenResult(await this.oauth.postToken(env, {
